                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">{BlogDetails?.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Education</Link></li>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Web Design</Link></li>
                                        <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently">Course</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/Letraset-Sheets-Passage-And-Recently" target="_blank"><Image src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-single/Letraset-Sheets-Passage-And-Recently" className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently"><i className="ti-facebook"></i></Link></li>
                                            <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently"><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently"><i className="ti-linkedin"></i></Link></li>
                                            <li><Link href="/blog-single/Letraset-Sheets-Passage-And-Recently"><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" href="/blog-single/Letraset-Sheets-Passage-And-Recently"><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
