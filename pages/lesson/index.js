                                    ...
                                    <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                                        ...
                                        <AccordionDetails>
                                            <div className="accordion-body">
                                                <ul className="item">
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.1<i
                                                    ...
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.2<i
                                                        className="fi flaticon-play-button"></i>Introduction of HTML
                                                        Editors</span> <span>30 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.3<i
                                                        className="fi flaticon-play-button"></i>Introduction of
                                                        Basic</span> <span>15 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.4<i
                                                        className="fi flaticon-play-button"></i>Introduction of
                                                        Style</span> <span><i className="fa fa-circle-thin"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.5<i
                                                        className="fi flaticon-play-button"></i>Introduction of
                                                        Start</span> <span><i className="fa fa-circle-thin"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.6<i
                                                        className="fi flaticon-play-button"></i>Introduction of
                                ...
                                <div className="accordion-item">
                                    <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                                        ...
                                        <AccordionDetails>
                                            <div className="accordion-body">
                                                <ul className="item">
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.1<i className="fi flaticon-play-button"></i>HTML
                                                        Elements</span> <span>20 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.2<i className="fi flaticon-play-button"></i>HTML
                                                        Attributes</span> <span>25 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.3<i className="fi flaticon-play-button"></i>HTML
                                                        Headings</span> <span>30 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.4<i className="fi flaticon-play-button"></i>HTML
                                                        Paragraphs</span> <span><i className="fa fa-circle-thin"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.5<i className="fi flaticon-play-button"></i>HTML
                                ...
                                <div className="accordion-item">
                                    <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                                        ...
                                        <AccordionDetails>
                                            <div className="accordion-body">
                                                <ul className="item">
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.1<i className="fi flaticon-play-button"></i>CSS
                                                        Introduction</span> <span>20 min<i
                                                            className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.2<i className="fi flaticon-play-button"></i>CSS
                                                        Syntax</span> <span>25 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.3<i className="fi flaticon-play-button"></i>CSS
                                                        Selectors</span> <span>30 min<i className="fa fa-check-circle"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.4<i className="fi flaticon-play-button"></i>CSS
                                                        Comments</span> <span><i className="fa fa-circle-thin"
                                                            aria-hidden="true"></i></span></Link></li>
                                                    <li><Link onClick={ClickHandler} href="/lesson"><span>1.5<i className="fi flaticon-play-button"></i>CSS
                        ...
                        <div className="col col-xl-9 col-lg-8 col-12">
                            <div className="video-area">
                                <div className="video-heading">
                                    ...
                                    <Link onClick={ClickHandler} className="theme-btn" href="/">Back To Home</Link>
                                </div>
                                <video autoPlay muted poster={'video'} loop>
                                    <source
                                        src={'/images/video/html.mp4'}
                                        type="video/mp4"
                                    />
                                </video>
                                ...
                                <div className="video-details-pagination">
                                    <ul>
                                        <li><Link onClick={ClickHandler} href="/lesson">Previews</Link></li>
                                        <li><Link onClick={ClickHandler} href="/lesson">Next</Link></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
